	...
	<div class="page-container"
		...
		<div class="form-card">
			...
			<div class="page-header">
				...
				<h2 class="page-title">User Transaction History</h2>
			</div>
			...
			<html:form action="/user/history" method="POST">
			...
			<div class="table-wrap" style="margin-top: 12px">
				<table class="table">
					...
					<tbody>
						<logic:empty name="userHistoryForm" property="trans">
							<tr>
								<td colspan="5" class="table-empty">No transactions</td>
							</tr>
						</logic:empty>

						<logic:notEmpty name="userHistoryForm" property="trans">
							<logic:iterate name="userHistoryForm" property="trans" id="t">
								<tr>
									<td><bean:write name="t" property="transId" /></td>
